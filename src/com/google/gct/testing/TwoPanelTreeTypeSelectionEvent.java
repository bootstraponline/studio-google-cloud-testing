...
class TwoPanelTreeTypeSelectionEvent {
  ...
  private GoogleCloudTestingType clickedType;

  public TwoPanelTreeTypeSelectionEvent(GoogleCloudTestingDimension currentDimension, GoogleCloudTestingType clickedType) {
