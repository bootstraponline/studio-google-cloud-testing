...
public abstract class GoogleCloudTestEventsProcessor implements Disposable {
  ...
  public abstract void onTestStarted(@NotNull GoogleCloudTestStartedEvent testStartedEvent);

  public abstract void onTestFinished(@NotNull GoogleCloudTestFinishedEvent testFinishedEvent);

  public abstract void onTestFailure(@NotNull GoogleCloudTestFailedEvent testFailedEvent);

  public abstract void onTestIgnored(@NotNull GoogleCloudTestIgnoredEvent testIgnoredEvent);

  public abstract void onTestOutput(@NotNull GoogleCloudTestOutputEvent testOutputEvent);
  ...
  public abstract void onConfigurationProgress(@NotNull TestConfigurationProgressEvent configurationProgressEvent);

  public abstract void onConfigurationScheduled(@NotNull TestConfigurationScheduledEvent configurationScheduledEvent);

  public abstract void onConfigurationFinished(@NotNull TestConfigurationFinishedEvent configurationFinishedEvent);
